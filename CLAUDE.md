...
**协作约定**：被问及 docs/ 下的文档时，优先读 `so101_pipeline.md` / `so101_pi05.md` / `so101_xvla.md` / `plan.md` / `bug.md` / `eval.md` / `inference.md` / `experiments_log.md`。`docs/source/` 下的 `.mdx` 参考其内容但不要修改（官方文档）。
